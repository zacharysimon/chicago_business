...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Uses data from https://data.cityofchicago.org/Community-Economic-Development/Business-Licenses-Current-Active/uupf-x98q to return data about Chicago Businesses}
